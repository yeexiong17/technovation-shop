      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
          {categoriesWithCounts.map((category, index) => (
            ...
            >
              <div className="aspect-[3/2] bg-card border border-border overflow-hidden mb-3 relative">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-5xl md:text-6xl opacity-20 group-hover:opacity-30 transition-opacity">
                    {category.icon}
                  </span>
                </div>
              ...
              <h2 className="font-serif text-lg md:text-xl group-hover:text-primary transition-colors">
                {category.name}
              </h2>
            </Link>
          ))}
