...
7. Configure SMTP/Mail settings (required for password reset functionality):

The application uses email for password reset functionality. You need to configure SMTP settings in your `.env` file.
...
3. Create a new app password for "Technovation"
...
MAIL_PASSWORD=your-app-password (without space)
MAIL_ENCRYPTION=tls
MAIL_FROM_ADDRESS=your-email@gmail.com
MAIL_FROM_NAME="${APP_NAME}"
```

**Note:** Replace `your-email@gmail.com` with your actual Gmail address and `your-app-password` with the 16-character app password generated by Google.
